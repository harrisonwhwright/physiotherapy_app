...
class appointments_page(tk.Toplevel):
    ...
    ### GPT
        ...
        appointment_time_label = tk.Label(add_appointment_frame, text="Time")
        ...
        appointment_time_label = tk.Label(add_appointment_frame, text="Date")
        appointment_time_label.grid(row=6, column=0)
        self.appointment_time_entry = tk.Entry(add_appointment_frame)
        self.appointment_time_entry.grid(row=6, column=1)

        self.appointment_status_selection = tk.StringVar()
        ...
        appointment_status_entry = ttk.OptionMenu(add_appointment_frame, self.appointment_status_selection, status_options[0], *status_options)
        appointment_status_entry.grid(row=7, column=1)
